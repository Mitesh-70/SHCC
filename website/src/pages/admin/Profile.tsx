        ...
        <form onSubmit={handleUpdate} className="bg-white rounded-xl shadow-card border border-gray-100 p-5 space-y-5">
          ...
          <div className="flex items-center gap-4 border-b border-gray-50 pb-4">
            ...
            <div>
              ...
              <span className="text-xs text-orange-600 bg-orange-50 px-2.5 py-0.5 rounded font-semibold mt-1 inline-block uppercase">Administrator</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                type="email"
                disabled
                value={user?.email || 'admin@shcc.co.in'}
