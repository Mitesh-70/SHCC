...
export default function FinanceSalesAnalysis() {
  return (
    <div className="bg-gray-50 min-h-screen pb-10">
      <Topbar title="Finance Sales Analysis" subtitle="Overview of monthly revenue comparisons, sales margins, and agent revenue statistics." />
      ...
      <div className="px-6 space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-card border border-gray-100 p-5">
          <h3 className="text-sm font-bold text-gray-800 mb-4">Salesperson Revenue Contribution</h3>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="table-header py-3 px-4 text-right">Target Achievement</th>
                </tr>
              </thead>
                ...
                {SALESPERSON_PERFORMANCE.map((sp, idx) => (
                  <tr key={idx} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="table-cell text-right">
                      <div className="w-full bg-gray-100 h-1.5 rounded-full overflow-hidden max-w-[120px] ml-auto">
                        <div
