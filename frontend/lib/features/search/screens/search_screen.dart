          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search ${_orders.length} orders...',
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.highlightOrderId != null) {
      for (final e in grouped.entries) {
        final containsHighlight = e.value.any(
          (o) => o['id'] == widget.highlightOrderId,
        );
      ...
      onTap: () {
        if (!_canEdit) {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) =>
                  CreateOrderScreen(prefill: order, isAdmin: isAdmin),
            ),
          );
        }
      },
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(order['buyer_name'] as String, style: AppTextStyles.heading2),
          ...
          children: [
            ...
            _DSection('Buyer Info', [
              ...
              if (order['remark'] != null &&
                  (order['remark'] as String).isNotEmpty)
